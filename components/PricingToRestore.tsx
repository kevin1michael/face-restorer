...
const PricingToRestore = () => {
  return (
    <>
      <div className="w-full h-full">
        <div className="w-full h-full">
          <div>
            <h2 className="text-3xl font-bold tracking text-center mt-12 sm:text-5xl ">
              Pricing
            </h2>
          ...
          <div className="mt-24 container space-y-12 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-x-8">
            ...
            <div className="relative p-8  border border-gray-200 rounded-2xl shadow-sm flex flex-col">
              <div className="flex-1">
                ...
                <p className="absolute top-0 py-1.5 px-4 bg-gradient-to-r from-emerald-500 to-blue-500 text-white rounded-full text-xs font-semibold uppercase tracking-wide  transform -translate-y-1/2">
                  Most popular
                </p>
                <p className="mt-4 flex items-baseline ">
                  <span className="text-5xl tracking-tight font-extralight">
                    $12
                  </span>
                  <span className="ml-1 text-xl font-semibold">/month</span>
                </p>
                ...
                <ul role="list" className="space-y-6 mt-56">
                  <li className="flex">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
...
export default PricingToRestore;
